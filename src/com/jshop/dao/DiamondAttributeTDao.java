...
public interface DiamondAttributeTDao {
	 ...
	 * @return
	 */
	public abstract List<DiamondAttributeT> findDiamondAttributeTByName(String name);
	/**
	 * 获取所有的商品参数
	 * @param currentPage
	 * @param lineSize
	 ...
	 * 获得钻石属性列表
	 * */
	public abstract List<DiamondAttributeT>  findDiamondAttibuteByType();
}
