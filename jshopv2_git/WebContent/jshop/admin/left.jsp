	...
	<div id="left">
		<div id="menu">
			...
			<ul id="menu-goods" class="opened">
				...
				<li>
					<a id="link18" href="<%=basePatha%>jshop/admin/goods/diamondattribute/attributemanagement.jsp?session=6584359BA964336B9BDE75737952F5AA#goods">钻石属性设置</a>
				</li>
				<li>
				...
				<li>
				 ...
				 <li>
					<a id="link9" href="<%=basePatha%>jshop/admin/goods/adddiamonds.jsp?session=6584359BA964336B9BDE75737952F5AA#goods">添加钻石</a>
				</li>
				<%-- <li>
