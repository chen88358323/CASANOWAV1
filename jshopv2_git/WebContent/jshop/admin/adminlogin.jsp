                                                  ...
                                                  <div class="form">
                                                            ...
                                                            <div class="fields">
                                                                      <div class="field">
                                                                                ...
                                                                                <div class="input">
                                                                                          <input type="text" id="username" name="username" size="40" value="sasasa" class="focus" />
                                                                                </div>
                                                                      </div>
                                                                      <div class="field">
                                                                                <div class="label">
                                                                                ...
                                                                                <div class="input">
                                                                                          <input type="password" id="password" name="password" size="40" value="sasasa" class="focus" />
                                                                                </div>
                                                                      </div>
                                                                      <div class="field">
                                                                                <div class="checkbox">
