...
public interface DiamondTService {
	 ...
	 * @return
	 */
	public abstract List<DiamondT> findDiamondByNavid(String navid, String salestate, final int currentPage, final int lineSize);
